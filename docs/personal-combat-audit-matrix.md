...
| Resource operations | yes | yes | yes | missing/invalid amount tests | yes |
...
| Snapshot trigger/hit and trigger/tick | yes | yes | yes | delayed numeric test | yes |
...
| Tune Break/Rupture | yes | existing formulas | yes | Damage Engine cross-checks | yes |
